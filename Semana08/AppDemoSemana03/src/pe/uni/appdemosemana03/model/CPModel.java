...
public class CPModel {
	...
	public CPModel(int idCursoProg, String idCurso, String curso, String idCiclo, String idProfesor, int vacantes, int matriculados, double preCursoProg, String horario, int activo) {
		this.idCursoProg = idCursoProg;
		this.idCurso = idCurso;
		this.curso = curso;
		this.idCiclo = idCiclo;
